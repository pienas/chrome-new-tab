...
(function (t) {
  ...
  t.uiBackCompat !== !1 &&
    ...
    t.widget("ui.autocomplete", {
      ...
      _renderItem: function (e, i) {
        return t("<li>")
          .append(
            t("<a>")
              .attr("href", `https://google.lt/search?q=${i.label}`)
              .text(i.label)
          )
          .appendTo(e);
      },
    ...
    t.widget("ui.controlgroup", {
              ...
              : (t.fn[s] &&
                  ...
                  e.element
                    ...
                    .each(function () {
                      var e = t(this),
                        n = e[s]("widget");
                      t.data(n[0], "ui-controlgroup-data", e[s]("instance")),
                        i.push(n[0]);
                    })),
                void 0)
            : void 0;
      ...
      _updateCornerClass: function (t, e) {
        var i = "ui-corner-top ui-corner-bottom ui-corner-left ui-corner-right",
        ...
        this._addClass(
          ...
          e.length &&
            (t.each(["first", "last"], function (t, s) {
              ...
              n && i["_" + n.widgetName + "Options"]
                ? n.element[n.widgetName](i["_" + n.widgetName + "Options"](s))
          ...
          this._toggleClass(
            ...
            this.options.icon &&
              ...
              this._toggleClass(
                this.icon,
                null,
                "ui-icon-check ui-state-highlight",
                e
    ...
    t.ui.button,
    t.extend(t.ui, { datepicker: { version: "1.12.0-rc.2" } });
  var g;
  t.extend(s.prototype, {
    ...
    (t.datepicker.version = "1.12.0-rc.2"),
    t.datepicker,
